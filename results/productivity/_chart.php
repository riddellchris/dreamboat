           ...
           ['Year', '" . $display_variable_name . "', '" . $display_variable_name . " Target','Hours', 'Hours Target','Productivity', 'Productivity Target'],";
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				...
				if ($row[$month_combo[$i]] != 0) {
					...
					$what_is_productivity[$month_combo[$i]] = 'null';
				}
				$i++;
				if ($row[$month_combo[$i]] != 0) {
					$what_is_productivity[$month_combo[$i]] = $row[$month_combo[$i]];
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				$all_null = 'yes';
				$i = 0;
				/*if($row[$month_combo[$i]] != 0){$what_is_productivity_target[$month_combo[$i]] = $row[$month_combo[$i]];$all_null = 'no';}	else{*/
				$what_is_productivity_target[$month_combo[$i]] = 'null';
				$i++; //}
				/*if($row[$month_combo[$i]] != 0){$what_is_productivity_target[$month_combo[$i]] = $row[$month_combo[$i]];$all_null = 'no';}	else{*/
				$what_is_productivity_target[$month_combo[$i]] = 'null';
				$i++; //}
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				...
				$i = 0;
				if ($row[$month_combo[$i]] != 0) {
					$hours[$month_combo[$i]] = $row[$month_combo[$i]];
					$all_null = 'no';
				} else {
					$hours[$month_combo[$i]] = 'null';
				}
				$i++;
				if ($row[$month_combo[$i]] != 0) {
					$hours[$month_combo[$i]] = $row[$month_combo[$i]];
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				$all_null = 'yes';
				$i = 0;
				/*if($row[$month_combo[$i]] != 0){$hours_target[$month_combo[$i]] = $row[$month_combo[$i]];$all_null = 'no';}	else{*/
				$hours_target[$month_combo[$i]] = 'null';
				$i++; //}$i ++;
				/*if($row[$month_combo[$i]] != 0){$hours_target[$month_combo[$i]] = $row[$month_combo[$i]];$all_null = 'no';}	else{*/
				$hours_target[$month_combo[$i]] = 'null';
				$i++; //}$i ++;
				...
				$i++; //}$i ++;
				if ($row[$month_combo[$i]] != 0) {
					$hours_target[$month_combo[$i]] = $row[$month_combo[$i]];
					$all_null = 'no';
				} else {
					$hours_target[$month_combo[$i]] = 'null';
				}
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				...
				$i = 0;
				if ($row[$month_combo[$i]] != 0) {
					$productivity[$month_combo[$i]] = $row[$month_combo[$i]];
					$all_null = 'no';
				} else {
					$productivity[$month_combo[$i]] = 'null';
				}
				$i++;
				if ($row[$month_combo[$i]] != 0) {
					$productivity[$month_combo[$i]] = $row[$month_combo[$i]];
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				$all_null = 'yes';
				$i = 0;
				/*if($row[$month_combo[$i]] != 0){$productivity_target[$month_combo[$i]] = $row[$month_combo[$i]];$all_null = 'no';}	else{*/
				$productivity_target[$month_combo[$i]] = 'null';
				$i++; //}$i ++;
				/*if($row[$month_combo[$i]] != 0){$productivity_target[$month_combo[$i]] = $row[$month_combo[$i]];$all_null = 'no';}	else{*/
				$productivity_target[$month_combo[$i]] = 'null';
				$i++; //}$i ++;
				...
				$i++; //}$i ++;
				if ($row[$month_combo[$i]] != 0) {
					$productivity_target[$month_combo[$i]] = $row[$month_combo[$i]];
					$all_null = 'no';
				} else {
					$productivity_target[$month_combo[$i]] = 'null';
				}
			...
			<?php $i = 0; ?>[<?php echo "'" . $display_month_combo[$i] . "'"; ?>, <?php echo $what_is_productivity[$month_combo[$i]]; ?>, <?php echo $what_is_productivity_target[$month_combo[$i]]; ?>,
			...
			[<?php echo "'" . $display_month_combo[$i] . "'"; ?>, <?php echo $what_is_productivity[$month_combo[$i]]; ?>, <?php echo $what_is_productivity_target[$month_combo[$i]]; ?>,
				<?php echo $hours[$month_combo[$i]]; ?>, <?php echo $hours_target[$month_combo[$i]]; ?>, <?php echo $productivity[$month_combo[$i]]; ?>, <?php echo $productivity_target[$month_combo[$i]]; ?>],
			<?php $i++; ?>[<?php echo "'" . $display_month_combo[$i] . "'"; ?>, <?php echo $what_is_productivity[$month_combo[$i]]; ?>, <?php echo $what_is_productivity_target[$month_combo[$i]]; ?>,
				<?php echo $hours[$month_combo[$i]]; ?>, <?php echo $hours_target[$month_combo[$i]]; ?>, <?php echo $productivity[$month_combo[$i]]; ?>, <?php echo $productivity_target[$month_combo[$i]]; ?>],
			<?php $i++; ?>[<?php echo "'" . $display_month_combo[$i] . "'"; ?>, <?php echo $what_is_productivity[$month_combo[$i]]; ?>, <?php echo $what_is_productivity_target[$month_combo[$i]]; ?>,
				<?php echo $hours[$month_combo[$i]]; ?>, <?php echo $hours_target[$month_combo[$i]]; ?>, <?php echo $productivity[$month_combo[$i]]; ?>, <?php echo $productivity_target[$month_combo[$i]]; ?>],
			<?php $i++; ?>[<?php echo "'" . $display_month_combo[$i] . "'"; ?>, <?php echo $what_is_productivity[$month_combo[$i]]; ?>, <?php echo $what_is_productivity_target[$month_combo[$i]]; ?>,
...
*/
		...
		var options = {
			...
			vAxes: {
				...
				0: {
					title: <?php echo "'" . ucfirst($display_variable_name) . "'},"; ?>
					1: {
						title: 'Hours',
						textPosition: 'out',
						color: '#800080'
