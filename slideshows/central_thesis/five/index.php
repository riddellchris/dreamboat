...
require $_SERVER['DOCUMENT_ROOT']."/slideshows/central_thesis/five/triangles.php";
...
echo "
   ...
   @media only screen and (min-width: 1200px)   and (max-width: 1700px) { #slideshow_middle{       margin-top: 35vh;}}
   @media only screen                           and (min-width: 1700px) { #slideshow_middle{       margin-top: 33vh;}}
