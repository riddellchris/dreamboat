...
echo "<div class='slideshow_title_container'>";
      echo "E.G. ECONOMIC OPTIMISATIONS";
...
echo "<div id='slideshow_diagram_block'>";
  ...
  echo "<div id='slideshow_column_1' class='slideshow_column'>";
    echo "<div class='db_info_box_title'>Pricing</div>";
  ...
  echo "<div id='slideshow_column_2' class='slideshow_column'>";
    echo "<div class='db_info_box_title'>Jobs</div>";
    echo "<div class='db_info_box red'>";
        /*
       echo "Find jobs that don't quite fit  
       <ul class='intab'>
      					 <li>comparative</li>
...
*/
  ...
  echo "<div id='slideshow_column_3' class='slideshow_column'>";
    echo "<div class='db_info_box_title'>Efficiency</div>";
    echo "<div class='db_info_box blue'>";
         echo "More specialised companies.
         <ul class='intab'>
                         <li>Operating in tighter niches for more profit</li>
  ...
  echo "<div id='slideshow_column_4' class='slideshow_column'>";
    echo "<div class='db_info_box_title'>Forecasting</div>";
    echo "<div class='db_info_box red'>";
