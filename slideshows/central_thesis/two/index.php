...
list_start();
    point_detailed_start('no', 10, 10,10,"If we don't manage to turn this <a href='https://www.investopedia.com/terms/p/per-capita-gdp.asp'>GDP per capita</a> into the target line marked...");
