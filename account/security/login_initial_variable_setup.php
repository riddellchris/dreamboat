...
if($row['client_or_crew'] == 'crew'){	$_SESSION['dreamboat_crew'] = 'yes';
					...
					if($row['dreamboat_management'] == 'yes'){	$_SESSION['dreamboat_management'] 		= 'yes';}
					if($row['dreamboat_admin'] 		== 'yes'){	$_SESSION['dreamboat_admin'] 			= 'yes';}
					if($row['dreamboat_developer'] 	== 'yes'){	$_SESSION['dreamboat_developer'] 		= 'yes';
...
if($row['client_or_crew'] == 'client'){
					...
					$sql = "SELECT * FROM user_account_details WHERE user_id = '".$_SESSION['pilots_id']."'";
