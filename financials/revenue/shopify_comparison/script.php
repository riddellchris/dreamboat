    ...
    echo "
      ...
      function <?php echo $location_string; ?>()            
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['Month',     'Total', { role: 'annotation' }, 'Shopify', { role: 'annotation' }],
          ['2004/05',   450,  '450',     614.6, '614'],          
          ['2004/05',   450,  '450',     614.6, '614'],
          ['2005/06',   288,  '288',     682, '682'],
          ['2006/07',   397,  '397',     623, '623'],
          ['2007/08',   215,   '215',    609.4, '609'],
          ['2008/09',   366,   '366',    569.6, '569']
        ]);
