...
.admin_layer_one_menu_container{width:100%;}
.admin_layer_one_menu.red{	background-color: #ff0000; color:white;}

//these should probably be tabulated somehow such that the presentation is clean

.sales{			background-color: #ffffff;	color: #281e96;}
.users{			background-color: #ffffff;	color: #281e96;}
.notes{			background-color: #ffffff;	color: #281e96;}
//.interrogation{	background-color: #D4D2EA;	color: #281e96;}
.advice{		background-color: #A9A5D5;	color: #281e96;}
.knowledge{		background-color: #7E78C0;	color: #ffffff;}
.comparison{	background-color: #534BAB;	color: #ffffff;}
...
.admin_layer_one_menu.users:hover{			background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.users:hover{			background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.notes:hover{			background-color: #ff0000; 		color: white;}
//.admin_layer_one_menu.interrogation:hover{	background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.advice:hover{			background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.knowledge:hover{		background-color: #ff0000;		color: white;}
.admin_layer_one_menu.comparison:hover{		background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.controls:hover{		background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.technology:hover{		background-color: #ff0000; 		color: white;}
.admin_layer_one_menu.other:hover{			background-color: #00FF00; 		color: black;}

.sales.alert{			background-color: orange;	color: #281e96;}
.users.alert{			background-color: orange;	color: #281e96;}
.notes.alert{			background-color: orange;	color: #281e96;}
//.interrogation.alert{	background-color: orange;	color: #281e96;}
...
.users.alert:hover{			background-color: #ffc169;	color: #281e96;}
.users.alert:hover{			background-color: #ffc169;	color: #281e96;}
.notes.alert:hover{			background-color: #ffc169;	color: #281e96;}
//.interrogation.alert:hover{	background-color: #ffc169;	color: #281e96;}
...
echo "  
  xhttp.open('GET', '/components/crew_bar/menu_system/container_calculations.php?change_to=primary_layer&to='+to'&primary_folder=".$_GET['primary_folder']."&secondary_folder=".$_GET['secondary_folder'];
