...
if($sub_sub_number_of_menu_options > 0){
	for($i = 0; $i < $sub_sub_number_of_menu_options; $i++){
		...
		if($_SESSION['dreamboat_crew'] == 'yes'){
			...
			if(	$_GET['primary_folder'] 	== 'time' 	&& $_GET['secondary_folder']	== 'optimisation' &&	$sub_sub_display_option[$i] 	== 'issues'){	$pilot_settings_class = " pilot_settings_in_sub_menus ";}
			if(	$_GET['primary_folder'] 	== 'time' 	&& $_GET['secondary_folder']	== 'optimisation' &&	$sub_sub_display_option[$i] 	== 'improvements'){	$pilot_settings_class = " pilot_settings_in_sub_menus ";}	
		...
		echo "<a ";		
			...
			//if($pilot_settings_class == '' && $_SESSION[$session_key] == $top_sub_sub_menu_options[$i]){echo " highlighted ";}
