...
//remove from /reporting/printing
$display['typing_bar'] = 'yes';
if(isset($_GET['tertiary_folder'])){if($_GET['tertiary_folder'] == 'print'){$display['typing_bar'] = 'no';}}

if($display['typing_bar'] == 'yes'){
