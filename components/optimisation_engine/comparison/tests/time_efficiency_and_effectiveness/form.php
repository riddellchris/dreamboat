...
<div>
	...
	<div>
		This test mirrors the data collected at /time/optimisation/ but provides better comparative data.<br>
		Similar to how all the other systems do / should
		....<br>
...
require $_SERVER['DOCUMENT_ROOT']."/admin/pages/comparison/tests/time_efficiency_and_effectiveness/name_ender_array.php";
//$name_ender[0] = "today";			
