...
.one{background-image: linear-gradient(<?php echo $degrees;?>deg, #3fe0bd, #3fe0bd);height:120vh;min-width: 450px;}
.mobile{background-image: linear-gradient(<?php echo $degrees;?>deg, #3fe0bd, #3fe0bd);height:120vh;min-height:1600px;}
...
.two_left{	text-align:center;padding-top:2vh;
...
if($_SESSION['dreamboat_crew'] == 'yes'){
	...
	@media screen and (min-width: 1200px) and (max-width: 2250px){
			.two_left{width:40%;padding-top:2%;}
			.two_right{width:52%;}
			}
	";
}
