...
if($_GET['secondary_folder'] != 'one' &&
  ...
  @media only screen and (max-width: 800px) {
    ...
    .slideshow_menu_left{   ";
	        if(check_secondary_folder('one') == true){
					echo	"background-color: transparent;";
                        }
			else {
					echo "background-color: #ff9494;";
			}
	        if(check_secondary_folder('ten') == true){
                echo $shadow_definition;
            }	
    ...
    if(check_secondary_folder('one') == 0){	
    ...
    if(check_secondary_folder('ten') == 0){	
...
echo "<div id='slideshow_menu' class='slideshow_menu_container' style='display:block;'>";
    ...
    echo "<a class ='slideshow_menu_inner slideshow_menu_left' ";
        if(check_secondary_folder('one') == 0){
        echo "href='/components/slideshows/move.php?direction=backwards&from=".$_GET['secondary_folder']."'";
		}
    ...
    echo "<a class ='slideshow_menu_inner slideshow_menu_right' ";
        if(check_secondary_folder('ten') == 0){    
        echo "href='/components/slideshows/move.php?direction=forwards&from=".$_GET['secondary_folder']."'";
		}
        else{
