...
$sql = "SELECT ".$_SESSION['progress_plus_how_why_category']." FROM progress_plus_core WHERE input_id = '".$_SESSION['progress_plus_insert_id']."' AND user_id = '".$_SESSION['user_id']."' ORDER BY input_id DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
