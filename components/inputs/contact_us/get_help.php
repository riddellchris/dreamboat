...
if($_SESSION['next_prompt_id'] == 55){$_SESSION['contact_us_first_name'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 56; header("Location: /contact_us/get_help/");exit();}
if($_SESSION['next_prompt_id'] == 56){$_SESSION['contact_us_second_name'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 57; header("Location: /contact_us/get_help/");exit();}
if($_SESSION['next_prompt_id'] == 57){$_SESSION['contact_us_phone_number'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 58; header("Location: /contact_us/get_help/");exit();}
if($_SESSION['next_prompt_id'] == 58){$_SESSION['contact_us_email_address'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 59; header("Location: /contact_us/get_help/");exit();}
if($_SESSION['next_prompt_id'] == 59){$_SESSION['contact_us_message'] 		= $_POST['textarea_input'];$_SESSION['next_prompt_id'] = 60; header("Location: /contact_us/get_help/");exit();}
if($_SESSION['next_prompt_id'] == 60){$_SESSION['contact_us_subject'] 		= $_POST['standard_input'];
	...
	$_SESSION['next_prompt_id'] = 124; 
	header("Location: /contact_us/get_help/");
	exit();
}
