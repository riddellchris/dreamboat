...
if($_SESSION['next_prompt_id'] == 145){$_SESSION['contact_us_first_name'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 146; header("Location: /contact_us/request_a_feature/");exit();}
if($_SESSION['next_prompt_id'] == 146){$_SESSION['contact_us_second_name'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 147; header("Location: /contact_us/request_a_feature/");exit();}
if($_SESSION['next_prompt_id'] == 147){$_SESSION['contact_us_phone_number'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 148; header("Location: /contact_us/request_a_feature/");exit();}
if($_SESSION['next_prompt_id'] == 148){$_SESSION['contact_us_email_address'] 	= $_POST['standard_input'];$_SESSION['next_prompt_id'] = 149; header("Location: /contact_us/request_a_feature/");exit();}
if($_SESSION['next_prompt_id'] == 149){$_SESSION['contact_us_message'] 		= $_POST['textarea_input'];$_SESSION['next_prompt_id'] = 150; header("Location: /contact_us/request_a_feature/");exit();}
if($_SESSION['next_prompt_id'] == 150){$_SESSION['contact_us_subject'] 		= $_POST['standard_input'];
	...
	$_SESSION['next_prompt_id'] = 151; 
	header("Location: /contact_us/request_a_feature/");
	exit();
}
