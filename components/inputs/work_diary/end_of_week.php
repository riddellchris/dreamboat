...
echo	$sql = "SELECT energy FROM progress_plus_core WHERE user_id = '".mysqli_real_escape_string($conn, $_SESSION['user_id'])."' ORDER BY input_id DESC LIMIT 1;";
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 67;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 68;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 69;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 70;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 71;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 72;}
...
if(	($_SESSION['next_prompt_id'] == 66 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 74;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 75;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 76;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 77;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 78;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 79;}
	$changed = 'yes';
}
if(	($_SESSION['next_prompt_id'] == 73 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 81;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 82;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 83;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 84;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 85;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 86;}
	$changed = 'yes';
}
if(	($_SESSION['next_prompt_id'] == 80 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 88;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 89;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 90;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 91;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 92;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 93;}
	$changed = 'yes';
}
...
if(	($_SESSION['next_prompt_id'] == 87 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 95;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 96;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 97;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 98;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 99;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 100;}
	$changed = 'yes';
}
if(	($_SESSION['next_prompt_id'] == 94 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 102;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 103;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 104;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 105;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 106;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 107;}
	$changed = 'yes';
}
if(	($_SESSION['next_prompt_id'] == 101 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 109;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 110;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 111;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 112;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 113;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 114;}
	$changed = 'yes';
}
if(	($_SESSION['next_prompt_id'] == 108 OR 
	...
	if($row['energy'] == 2){	$_SESSION['next_prompt_id'] = 116;}
	if($row['energy'] == 1){	$_SESSION['next_prompt_id'] = 117;}
	if($row['energy'] == 0){	$_SESSION['next_prompt_id'] = 118;}
	if($row['energy'] == -1){	$_SESSION['next_prompt_id'] = 119;}
	if($row['energy'] == -2){	$_SESSION['next_prompt_id'] = 120;}
	if($row['energy'] == -3){	$_SESSION['next_prompt_id'] = 121;}
	$changed = 'yes';
}
