...
$changed = 'no';
if($_SESSION['next_prompt_id'] == 133 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 134;}
if($_SESSION['next_prompt_id'] == 134 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 135;}
if($_SESSION['next_prompt_id'] == 135 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 136;}
if($_SESSION['next_prompt_id'] == 136 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 137;}
if($_SESSION['next_prompt_id'] == 137 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 138;}
if($_SESSION['next_prompt_id'] == 138 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 139;}
if($_SESSION['next_prompt_id'] == 139 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 140;}
...
if($_SESSION['next_prompt_id'] == 142 && $changed == 'no'){$changed = 'yes';$_SESSION['next_prompt_id'] = 143;}
...
header("Location: /work_diary/questions/");
?>