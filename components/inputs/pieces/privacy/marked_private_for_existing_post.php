...
if($row['input_id'] == ''){
	$sql = "UPDATE network_posts SET privacy='private' WHERE user_id = '".mysqli_real_escape_string($conn, $_SESSION['user_id'])."' AND input_id='".mysqli_real_escape_string($conn, $_GET['input_id'])."'";
