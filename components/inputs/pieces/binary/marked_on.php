...
<div style='text-align: center;'>
	<div style='width:100%;max-width:1100px;display: inline-block;padding: 0px 0px;'>
		<div class='wide-button' style='box-shadow:inset 0px 4px 12px rgba(0, 0, 0, 0.4);padding: 3px 0px;padding-top:10px;color:#fff;width:50%;background-color: grey;display:block;float: left;height: 26px;'  onclick="mark_off();">
				<?php echo "make ".$_SESSION['binary_display_for_off'];?>
		</div>
		<div class='wide-button shadow'  style='padding: 3px 0px;padding-top:10px;color:#fff;width:50%;background-color: #00e200;display:block;margin-left: 50%;height: 26px;max-width:550px;' onclick="mark_off();">
				<?php echo $_SESSION['binary_display_for_on'];?>
		</div>
	</div>	
</div>	