...
if($_SESSION['viewing_client_mental_health_only'] != 'yes'){	
	...
	echo "<a class='dulled_nav about_us nav-links wide-nav";
		...
		echo "' style='";	
		if(check_url('/business/') == 1 OR $_SESSION['primary_folder'] == 'business'){echo "color:#00ff00;";}
...
if($_SESSION['viewing_client_sales_process_involvement_yes_no'] == 'yes'){	
	...
	echo "<a class='about_us nav-links wide-nav";
		...
		echo "' style='";	
		if(check_url('/wheelhouse/') == 1 OR $_SESSION['primary_folder'] == 'wheelhouse'){echo "color:#00ff00;";}
	...
	echo "<a class='about_us nav-links wide-nav";
		...
		echo "' style='";	
		if(check_url('/activities/') == 1 OR $_SESSION['primary_folder'] == 'activities'){echo "color:#00ff00;";}
	...
	echo "<a class='dulled_nav about_us nav-links wide-nav";
		...
		echo "' style='";	
		if(check_url('/improvements/') == 1 OR $_SESSION['primary_folder'] == 'improvements'){echo "color:#00ff00;";}
	...
	echo "<a class='dulled_nav about_us nav-links wide-nav";
		...
		echo "' style='";	
		if(check_url('/notifications/') == 1 OR $_SESSION['primary_folder'] == 'notifications'){echo "color:#00ff00;";}
...
/*		
	echo "<a class='dulled_nav about_us nav-links wide-nav";
		...
		style='";	
		if(check_url('/admin/') == 1 OR $_SESSION['primary_folder'] == 'admin'){echo "color:#00ff00;";}
		echo "' href='/admin/'";
...
if($_SESSION['logged_in'] != 'yes' OR 
 ...
 check_url('/content/') == 1
	...
	if($_SESSION['logged_in'] == 'yes'){
		echo "<a class='about_us nav-links wide-nav' style='";	
		if(check_url('/content/about/') == 1){echo "color:#00ff00;";}
