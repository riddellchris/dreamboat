...
<div style='width:100%;height:60vh;padding:0px;'>

	<div style='width:45%;float:left;padding:0px;'>
	
		<div class='hero-image' style='height:60vh;background-color:red;'>
...
$sql = "SELECT * FROM work_diary WHERE user_id = '1' ORDER BY input_id DESC LIMIT 10";
$result = mysqli_query($conn, $sql);
