...
if($_GET['to'] == 'groups'	){$new_category = $_GET['to'];	$_SESSION['network_page'] = $new_category;}
if($_GET['to'] == 'businesses'	){$new_category = $_GET['to'];	$_SESSION['network_page'] = $new_category;}
...
$sql = "UPDATE organisations ".$query_element."
...
header("Location: /network/".$new_category."/item/display.php?item_id=".$_GET['item_id']);
exit();
