...
if($_GET['to'] == 'new_potentials'		){$new_category = $_GET['to'];	$_SESSION['sales_page'] = $new_category;}
if($_GET['to'] == 'potential_upsells'		){$new_category = $_GET['to'];	$_SESSION['sales_page'] = $new_category;}
if($_GET['to'] == 'recurring_sales'		){$new_category = $_GET['to'];	$_SESSION['sales_page'] = $new_category;}
...
header("Location: /sales/".$new_category."/item/display.php?item_id=".$_GET['item_id']);
