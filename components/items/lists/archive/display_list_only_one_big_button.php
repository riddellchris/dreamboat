	...
	if($notifications == 'no' && $_SESSION['primary_folder'] != 'content'){ 
		...
		echo "<div style='width:100%;padding:20px 0px;text-align:center;'>";
			...
			if($_SESSION['list_view_'.$_SESSION['primary_folder'].'_'.$_SESSION['secondary_folder']] != 'deleted' AND $_SESSION['list_view_'.$_SESSION['primary_folder'].'_'.$_SESSION['secondary_folder']] != 'inactive'){			
				...
				if($_SESSION['primary_folder'] == 'sales'){
					if($_SESSION['secondary_folder'] == 'new_potentials'){	 $_SESSION['adding_new'] = 'prospects';		$achieved_name = 'closed';		$button_copy =  "ADD A potential inital sale";}	
				...
				if($_SESSION['primary_folder'] == 'marketing'){	
					...
					if($_SESSION['secondary_folder'] == 'angles'){		$_SESSION['adding_new'] = 'marketing_angles';	$achieved_name = 'redundant';		$button_copy =  "ADD A marketing angle";}									
				}							
