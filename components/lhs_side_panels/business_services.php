...
?> 
	...
	><?php if(isset($row['standard_customer_journey'])){ echo $row['standard_customer_journey']; }?></textarea><br>
	...
	><?php if(isset($row['intial_engagements'])){ echo $row['intial_engagements']; }?></textarea><br>
	...
	><?php if(isset($row['standard_projects'])){ echo $row['standard_projects']; }?></textarea><br>
	...
	><?php if(isset($row['ongoing_work'])){ echo $row['ongoing_work']; }?></textarea><br>
	...
	><?php if(isset($row['disengagement_issues'])){ echo $row['disengagement_issues']; }?></textarea><br>
	...
	><?php if(isset($row['upsell_and_onsell_potential'])){ echo $row['upsell_and_onsell_potential']; }?></textarea><br>	
	...
	><?php if(isset($row['other_services_notes'])){ echo $row['other_services_notes']; }?></textarea><br>
