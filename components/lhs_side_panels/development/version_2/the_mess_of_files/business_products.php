...
?> 
	...
	><?php echo $row['other_product_groupings'];?></textarea><br>
	...
	><?php echo $row['comparative_examples'];?></textarea><br>
	...
	><?php echo $row['key_value_propositions'];?></textarea><br>
	...
	><?php echo $row['future_line_expansions'];?></textarea><br>
	...
	><?php echo $row['other_product_notes'];?></textarea><br>
