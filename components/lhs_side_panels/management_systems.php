...
?> 
	...
	><?php if(isset($row['current_systems_issues'])){echo $row['current_systems_issues'];} ?></textarea><br>
	...
	><?php if(isset($row['potential_systems_improvements'])){echo $row['potential_systems_improvements'];} ?></textarea><br>
	...
	><?php if(isset($row['overdue_systems_simplifications'])){echo $row['overdue_systems_simplifications'];} ?></textarea><br>
	...
	><?php if(isset($row['systems_user_engagement_issues'])){echo $row['systems_user_engagement_issues'];} ?></textarea><br>
	...
	><?php if(isset($row['business_systems_issues'])){echo $row['business_systems_issues'];} ?></textarea><br>
	...
	><?php if(isset($row['future_systems_requirements'])){echo $row['future_systems_requirements'];} ?></textarea><br>
	...
	><?php if(isset($row['other_systems_notes'])){echo $row['other_systems_notes'];} ?></textarea><br>
