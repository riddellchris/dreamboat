...
?>
	...
	><?php if(isset($row['staff_vision'])){echo $row['staff_vision'];}?></textarea><br>
	...
	><?php if(isset($row['critical_cultural_notes'])){echo $row['critical_cultural_notes'];}?></textarea><br>
	...
	><?php if(isset($row['hiring_channels'])){echo $row['hiring_channels'];}?></textarea><br>
	...
	><?php if(isset($row['hiring_processes'])){echo $row['hiring_processes'];}?></textarea><br>
	...
	><?php if(isset($row['biggest_staffing_issues'])){echo $row['biggest_staffing_issues'];}?></textarea><br>
	...
	><?php if(isset($row['other_staff_notes'])){echo $row['other_staff_notes'];}?></textarea><br>
