...
?> 
	...
	><?php if(isset($row['market_sizings'])){ echo $row['market_sizings']; } ?></textarea><br>
	...
	><?php if(isset($row['main_competitors'])){ echo $row['main_competitors']; } ?></textarea><br>
	...
	><?php if(isset($row['key_differentiators'])){ echo $row['key_differentiators']; } ?></textarea><br>	
	...
	><?php if(isset($row['current_channels'])){ echo $row['current_channels']; } ?></textarea><br>
	...
	><?php if(isset($row['dream_channels'])){ echo $row['dream_channels']; } ?></textarea><br>
	...
	><?php if(isset($row['lead_times'])){ echo $row['lead_times']; } ?></textarea><br>
