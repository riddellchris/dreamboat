...
?> 
	...
	><?php if(isset($row['pain_points'])){echo $row['pain_points'];} ?></textarea><br>
	...
	><?php if(isset($row['urgency_tipping_points'])){echo $row['urgency_tipping_points'];} ?></textarea><br>
	...
	><?php if(isset($row['key_sales_phrases'])){echo $row['key_sales_phrases'];} ?></textarea><br>
	...
	><?php if(isset($row['expansion_processes'])){echo $row['expansion_processes'];} ?></textarea><br>
	...
	><?php if(isset($row['other_sales_notes'])){echo $row['other_sales_notes'];} ?></textarea><br>	
