...
//	echo(strtotime("18 May 2019") . "<br>");	
	...
	if($users_day_of_the_week == '1'){$twenty_four_hr_end_of_work_time = $row['am_monday'];		}
	if($users_day_of_the_week == '2'){$twenty_four_hr_end_of_work_time = $row['am_tuesday'];	}
	if($users_day_of_the_week == '3'){$twenty_four_hr_end_of_work_time = $row['am_wednesday'];	}
	if($users_day_of_the_week == '4'){$twenty_four_hr_end_of_work_time = $row['am_thursday'];	}
	if($users_day_of_the_week == '5'){$twenty_four_hr_end_of_work_time = $row['am_friday'];		}
	if($users_day_of_the_week == '6'){$twenty_four_hr_end_of_work_time = $row['am_saturday'];	}
	if($users_day_of_the_week == '0'){$twenty_four_hr_end_of_work_time = $row['am_sunday'];		}
...
//echo "<br><br>";
	...
	echo 	$SecondsDifference/60;
		if($SecondsDifference > -1800 AND $SecondsDifference < 1800){
			...
			$url		= "https://dreamboat.com.au/work_diary/incoming.php?user_id=".$user_id."&security_key=".$security_key;
			require $_SERVER['DOCUMENT_ROOT']."/back_of_house/emails/work_diary/start_of_day_reminder.php";
			
			//set the icon to red
echo			$sql = "UPDATE work_diary
