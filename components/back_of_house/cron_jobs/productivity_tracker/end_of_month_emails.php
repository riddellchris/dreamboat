...
//end of month - is sent out at the end of the working week that ends that month.
//therefore

//if withing the last days of the month 
//and gmdate( users_current_time ) = 5;

//send it out

///but for now let's just send it out at midday on the first of every month.
//to review the past month... KISS

//therefore the cron job is every hour.
