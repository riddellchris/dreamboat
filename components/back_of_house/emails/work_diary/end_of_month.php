...
$mail->Body    = $header.$horizontal_line.$body_top."<span style='text-shadow: 2px 2px 4px grey;
    ...
    font-size: 28px;
    color: #281e96;'>Great stuff ".$first_name." you're almost done for the week! <br>Before you're done let's take a little look back and plan ahead for next week on progress plus! <br>Just click the button below:</span><BR>
