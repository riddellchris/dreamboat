...
$mail->Subject = $first_name." let's track this week's productivity!!!!";
$mail->Body    = $header.$horizontal_line.$body_top."<span style='text-shadow: 2px 2px 4px grey;
    font-family: helvetica;
    text-transform: uppercase;
    font-size: 28px;
    color: #281e96;'>Great stuff ".$first_name." you're almost done for the week! <br>Before you pack up let's look back at the week's productivity! <br>Just click the button below:</span><BR>
<a href='".$url."'  style='min-width: 300px;
		    ...
		    text-indent: 0px;
		    text-shadow: none;
		    display: inline-block;'>Let's do it</a>".$body_bottom.$horizontal_line.$footer;
$mail->AltBody = "Great stuff ".$first_name." you're almost done for the week! <br>Before you pack up let's look back at the week's productivity!<br>Just visit the url below<br>".$url;
