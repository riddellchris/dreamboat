...
$subject[3] = "Home time ".$first_name."!";
...
$mail->Body    = $header.$horizontal_line.$body_top."<span style='text-shadow: 2px 2px 4px grey;
    ...
    font-size: 28px;
    color: #281e96;'>Great stuff ".$first_name." you finished work! <br>Now let's see how your progress went today! <br>Just click the button below:</span><BR>
...
$mail->AltBody = "You finished work! <br>Now let's see how your productivity was! <br>Just visit the url below<br>".$url;
