...
require_once $_SERVER['DOCUMENT_ROOT']."/components/back_of_house/emails/account_connection/notifications.php";
...
require_once $_SERVER['DOCUMENT_ROOT']."/components/back_of_house/emails/template/header.php";
require_once $_SERVER['DOCUMENT_ROOT']."/components/back_of_house/emails/template/body_top.php";
require_once $_SERVER['DOCUMENT_ROOT']."/components/back_of_house/emails/template/body_bottom.php";
require_once $_SERVER['DOCUMENT_ROOT']."/components/back_of_house/emails/template/footer.php";
...
$mail->AltBody = $email_instruction."<br>".$url;
