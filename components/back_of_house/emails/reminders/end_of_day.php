...
$email_type = 'Daily Productivity Improvement';
...
$subject[3] = "Let's make tomorrow better now ".$first_name."!";
$subject[4] = "Home time ".$first_name."!";
...
$mail->Body    = $header.$horizontal_line.$body_top."<span style='text-shadow: 2px 2px 4px grey;
    ...
    font-size: 28px;
    color: #281e96;'>Great stuff ".$first_name." you finished work! <br>Now let's complete your productivity improvement diary! <br>Just click the button below:</span><BR>
...
$mail->AltBody = "You finished work! <br>Now let's review your day! <br>Just visit the url below<br>".$url;
