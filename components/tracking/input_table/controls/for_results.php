...
if(	
	...
	$_SESSION['results_page'] == 'productivity'){
		...
		$variable_name = $_SESSION['viewing_client_what_is_productivity'];
		require $_SERVER['DOCUMENT_ROOT'].'/components/tracking/input_table/generic.php';
		
	// if($_SESSION['viewing_client_what_is_productivity'] == 'kpi_1'){
	// 	$variable_name = 'kpi_1';	require $_SERVER['DOCUMENT_ROOT'].'/components/tracking/input_table/generic.php';
	// }
	// if($_SESSION['viewing_client_what_is_productivity'] == 'kpi_2'){	
	// 	$variable_name = 'kpi_2';	require $_SERVER['DOCUMENT_ROOT'].'/components/tracking/input_table/generic.php';
	// }
	// if($_SESSION['viewing_client_what_is_productivity'] == 'kpi_3'){
