...
<?php
    ...
    if($_GET['secondary_folder'] == 'four'){    $image_to_show = '1';}
    if($_GET['secondary_folder'] == 'nine'){    $image_to_show = '3';}
    if($_GET['secondary_folder'] == 'ten'){     $image_to_show = '1';}
...
if($_GET['secondary_folder'] == 'four'){  $people = '#cecece'; $internal_data = '#cecece'; $external_data = '#cecece';    $triangle_color= '#cecece';}
if($_GET['secondary_folder'] == 'nine'){ $people = 'forestgreen'; $internal_data = '#cecece'; $external_data = '#cecece';  $triangle_color= 'red';}
if($_GET['secondary_folder'] == 'ten'){ $people = '#cecece';     $internal_data = '#F5BD02'; $external_data = '#cecece';  $triangle_color= 'red';}
...
<div id='slideshow_diagram_block'>
    <div id='process_diagram_left_block'>
        <div class='db_info_box ";
            if($_GET['secondary_folder'] == 'ten' OR $_GET['secondary_folder'] == 'four' ){echo " grey ";}
            else{echo " blue ";}
                echo "'>
            <div class='box_title";
                if($_GET['secondary_folder'] == 'ten' OR $_GET['secondary_folder'] == 'four' ){echo " grey ";}
          ...
          if($_GET['secondary_folder'] == 'ten' OR $_GET['secondary_folder'] == 'four' ){echo "      <ul style='color: #cecece;'>";}     
          else{echo "<ul>";}  
      ...
      <div class='db_info_box ";
            if(
            $_GET['secondary_folder'] == 'nine'  OR $_GET['secondary_folder'] == 'four' 
            ){echo " grey ";}
            else{echo " blue ";}
                echo "'>
            <div class='box_title";
                if($_GET['secondary_folder'] == 'nine'  OR $_GET['secondary_folder'] == 'four' 
                ){echo " grey ";}
                echo "'>
                business data
            </div>";
      ...
      <div class='db_info_box ";
            if( $_GET['secondary_folder'] == 'ten' OR
                $_GET['secondary_folder'] == 'nine'  OR $_GET['secondary_folder'] == 'four' 
            ){echo " grey ";}
            else{echo " blue ";}
                echo "'>
            <div class='box_title";
                if($_GET['secondary_folder'] == 'ten' OR $_GET['secondary_folder'] == 'nine'  OR $_GET['secondary_folder'] == 'four' 
                ){echo " grey ";}
                echo "'>
                External data
            </div>    
    ...
    <div id='process_diagram_central_block'>
        <div id='optimisation_engine_box' class='db_info_box ";
                    if( $_GET['secondary_folder'] == 'three'            ){echo " grey ";}
            else{echo " red ";}
           //     echo "'>";
                     echo "style='color: #281e96;'>";    
         echo " 
            <div class='box_title";
            if($_GET['secondary_folder'] == 'three' 
                ){echo " grey ";}
                echo "'>
...
point_detailed_start('no',8,8,8,"As well as basic productivity issue removal based on Pilot observations."); 
            ...
            <div class='icon_div'>
                <i id='slideshow_server' class='fas fa-server' ";
                    if($_GET['secondary_folder'] == 'three'){echo "style='         color: #cecece;'";}
