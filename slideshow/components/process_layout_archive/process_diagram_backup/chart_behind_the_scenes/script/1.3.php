    ...
    <script type="text/javascript">
      ...
      data.addRows([
        [420,  500,  null, null,   null],
        [400,  500,  null, null,   null],  
        [300,  500,  null, null,   null],  
        [280,  500,  null, null,   null],  
        [260,  500,  null, null,   null],  
        [240,  500,  null, null,   null],  
        [220,  500,  null, null,   null],  
        [200,  500,  null, null,   null],  
        [150,  500,  null, null,   null],        
        ...
        var options = {
          ...
          legend: 'none',
           series: {
            0: { color: 'grey', lineWidth: 0, lineDashStyle: [14, 2, 2, 7], pointSize: 30,  pointShape: { type: 'triangle', rotation: 90 } },
