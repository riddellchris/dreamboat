...
<div id='slideshow_diagram_block'>
    ...
    <div id='process_diagram_mid_arrows_block'>
        <div id='small_triangle_to_left_top'    class='small_triangle_to_left'>
        </div>
        <div id='small_triangle_to_left_middle' class='small_triangle_to_left'>
        </div>
        <div id='small_triangle_to_left_bottom'    class='small_triangle_to_left'>
        </div>
";
