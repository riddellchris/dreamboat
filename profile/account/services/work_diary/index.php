...
$_SESSION['access_time_settings_from'] = 'tracker';
...
echo "<a class='green-button wide-button' href='/about_us/our_products/index.php?primary_tab_to_open=work_diary'>info</a>";
echo "<br>";
