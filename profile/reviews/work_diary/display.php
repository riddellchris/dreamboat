...
if(mysqli_num_rows($result) == 0){
	...
	echo "<div class ='prompt-font' style='margin-top:20vh;'>Sorry you don't have any ";
	if($_SESSION['menu_set_diary'] == 'daily'	){echo $_SESSION['menu_set_diary'];}
	if($_SESSION['menu_set_diary'] == 'weekly' 	){echo $_SESSION['menu_set_diary'];}	
	if($_SESSION['menu_set_diary'] == 'monthly' 	){echo $_SESSION['menu_set_diary'];}	
	echo " diary entries<br>To get some you just need to wait for the next period to end</div>";
}
else{
