...
if(mysqli_num_rows($result) == 0){
	...
	echo "<div class ='prompt-font' style='margin-top:20vh;'>Sorry you don't have any reviews currently completed<br>You may start to complete this at the <span style='color:red;'>end of this week</span>.</div>";
}
else{
