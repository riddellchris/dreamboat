...
echo "<div class='Row'>";
	...
	if($row['mood'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['mood'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['mood'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	if($row['mood'] == 0){$background_color = 'transparent';$color= 'grey';		}	
	if($row['mood'] == -1){$background_color = '#ff7a7a';	$color= '#034c0a';	}	
	if($row['mood'] == -2){$background_color = '#ff5454';	$color= '#034c0a';	}
	if($row['mood'] == -3){$background_color = '#d62c2c';	$color= '#034c0a';	}		
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['mood_why']."'>";	
		echo $row['mood'];
		echo "<br>";
	echo "</div>";
	if($row['productivity'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['productivity'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['productivity'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	...
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['productivity_why']."'>";	
		...
		echo "<br>";
	echo "</div>";
		if($row['health'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['health'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['health'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	...
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['health_why']."'>";	
		...
		echo "<br>";
	echo "</div>";
	if($row['happiness'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['happiness'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['happiness'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	...
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['happiness_why']."'>";	
		...
		echo "<br>";
	echo "</div>";
		if($row['focus'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['focus'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['focus'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	...
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['focus_why']."'>";	
		...
		echo "<br>";
	echo "</div>";
		if($row['stress'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['stress'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['stress'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	...
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['stress_why']."'>";	
		...
		echo "<br>";
	echo "</div>";
		if($row['confidence'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['confidence'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['confidence'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
	...
	echo "<div class='Cell' style='background-color:".$background_color.";color:".$color."' title='".$row['confidence_why']."'>";	
		echo $row['confidence'];
		echo "<br>";
	echo "</div>";
		if($row['control'] == 3){$background_color = '#017c0d';	$color= '#ffffff';	}
	if($row['control'] == 2){$background_color = '#21b72f';	$color= '#ffffff';	}
	if($row['control'] == 1){$background_color = '#58ef66';	$color= '#034c0a';	}	
