...
$sql = "SELECT * FROM reviews_monthly_personal_productivity WHERE user_id = '".$_SESSION['viewing_client_id']."' ORDER BY input_id DESC";
...
//	require $_SERVER['DOCUMENT_ROOT']."/components/layouts/standard_page/spacings/start_of_page_top_of_centering_divs.php";
	...
	$sql = "SELECT * FROM work_diary WHERE user_id = '".$_SESSION['user_id']."' ORDER BY input_id DESC";
	$result = mysqli_query($conn, $sql);
