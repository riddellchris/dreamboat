...
$sql = "SELECT * FROM api_xero_reports_pnl_by_calendar_month
                            ...
                            AND          ( account_name = 'Total Income' OR  account_name = 'Sales' ) 
                            AND           date_index > -7
                    ...
                    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                      ...
                      if($row['account_name'] == 'Sales'){ $extracted['Sales'][$date_index] = $row['value'];} 
                    ...
                    for($extraction_counter = -6; $extraction_counter < 0; $extraction_counter ++){
                      echo " ['".$extracted['period_for_chart_display'][$extraction_counter]."',       
                                ...
                                ".$extracted['Sales'][$extraction_counter].",      '".$extracted['Sales'][$extraction_counter]."'],      ";
