...
require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/layout/pre_content.php";
		...
		paragraph_detailed('no',10,10,10,"At Dreamboat we define issues as anything that limits an entity from operating at gold standard productivity.
				<br>The sum of these issues we define as <a href='/knowledgebase/productivity/resistance/' target='_blank'>productivity resistance</a>.	
				<br>We represent this diagramatically as the dot below.");
		...
		list_start();
			point_detailed_start('no',6,8,8,"Poor internal <span style='color:red;'>communication</span> from too much reliance on technology to communicate, as opposed to just talking, can lead to a lack of trust in each other and cause bottle necks in all sorts of workflows.");
			...
			point_detailed_start('no',6,8,8,"Lack of <span style='color:red;'>value</span> extraction from each client due to a lack of <span style='color:red;'>skills</span> and/or <span style='color:red;'>attention.</span>");	point_end_only();	
		list_end();
