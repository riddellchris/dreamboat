...
require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/layout/pre_content.php";
		...
		echo "<img src='/knowledgebase/productivity/definition/diagrams/productivity_ticks.svg' style='width:100%;'>";
	
		paragraph_detailed('no',10,8,8, " and to turn those ticks green they are using up resources");
		
		echo "<img src='/knowledgebase/productivity/definition/diagrams/productivity_ticks_with_gold.svg' style='width:100%;'>";
