...
if($_GET['secondary_folder'] == 'immediate_plan'){
	...
	secondary_knowledgebase_menu_item('results',	'no');	
	if($_GET['tertiary_folder'] == 'results'){		
		tertiary_knowledgebase_menu_item('measurement_challenges','no');
		}
	secondary_knowledgebase_menu_item('rollout_plan',	'yes');	
	}
