...
list_start();
	...
	point_detailed_start('yes',10,10,10,"Be independent of government policy change risk, implementation and reliability issues.
						<br> 
						<span style='color:grey;'>&nbsp;&nbsp;This does not mean we are against the government in general, or at all for that matter.</span>");
	point_end_only();
...
list_start();
	...
	point_end_only();	
	point_detailed_start('no',7,10,8,"Produce real cash benefits above and beyond cash outlays in a consistent and reliable fashion.");
	point_end_only();	
...
list_start();
	...
	point_end_only();
	point_detailed_start('no',5,10,10,"Not cost much 'more than a phone plan' per employee to limit initial implementation costs and cash flow issues.");
	point_end_only();			
