...
require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/layout/pre_content.php";
	...
	paragraph_detailed('no',8,10,10,"With interest rates 0.25% and RBA Governor Phillip Lowe saying negative rates are highly unlikely, this economic lever is no longer available to us.");
	//require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/problems_and_solutions/economic/economic_background/interest_rate_chart/div.php";
		echo "<img src='/knowledgebase/problems_and_solutions/economic/economic_background/svg_charts/_ RBA Cash Rate.svg' style='width: 100%; margin-left: -5%;  margin-right: -5%;'>";
	...
	//require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/problems_and_solutions/economic/economic_background/household_debt_to_gdp/div.php";	
		echo "<img src='/knowledgebase/problems_and_solutions/economic/economic_background/svg_charts/Australian Household Debt to GDP Ratio.svg' style='width: 100%; margin-left: -5%;  margin-right: -5%;'>";
	...
	//require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/problems_and_solutions/economic/economic_background/gdp/div.php";
	...
	//require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/problems_and_solutions/economic/economic_background/gdp_percentage_change/div.php";
	
	paragraph_detailed('no',10,10,9,"Further to that productivity improvement has all but stalled since 2016.");
	require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/problems_and_solutions/economic/economic_background/productivity/div.php";
	
	paragraph_detailed('no',10,9,9,"Wages have stalled and in real terms are on the verge of going backwards.");
	require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/problems_and_solutions/economic/economic_background/wages/div.php";	
