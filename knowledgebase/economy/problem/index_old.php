...
require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/layout/pre_content.php";
	...
	paragraph_detailed('yes',10,10,10,"The economic fundamentals in Australia are broken with interest rates near 0, household debt sky high and real wage growth near 0.");
	paragraph_detailed('no',8,10,10,"With interest rates at 0.1% and RBA Governor Phillip Lowe saying negative rates are highly unlikely, this economy lever is no longer available to us, or at the very least no longer working.");
					    
	require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/economy/problem/interest_rate_chart/div.php";
	
	echo "<br><br><br><br>";
	
	//	echo "<img src='/knowledgebase/economy/problem/svg_charts/_ RBA Cash Rate.svg' style='width: 100%; margin-left: -5%;  margin-right: -5%;'>";
...
/*	list_start();
	...
	//	echo "<img src='/knowledgebase/economy/problem/svg_charts/Australian Household Debt to GDP Ratio.svg' style='width: 100%; margin-left: -2%;  margin-right: -5%;'>";
	echo "<br><br><br><br>";		
			
	paragraph_detailed('no',6,10,10,"While taking on this debt has helped ensure a huge period of extended GDP growth. Taking on more debt to ensure economy growth is now almost impossible so again that economy lever is no longer available to us.");
	//require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/economy/problem/gdp/div.php";
	...
	paragraph_detailed('no',10,10,9,"Further to that productivity improvement has all but stalled since 2016, apart from the recent COVID 'blip' as lower paying jobs and businesses caused a statistical anomaly.");
...
//	https://tradingeconomys.com/australia/inflation-cpi
	...
	paragraph_detailed('no',10,10,9,"If wages stop growing as a result of productivity stopping, then there is a serious risk that the house of cards starts to crumble, mostly under the weight of the debt we can't get out of and need higher wages to start paying for. Unfortunately with interest rates at near zero no further payment reductions can occur.");
	...
	paragraph_detailed('no',10,10,9,"So to keep the economy growing, and our way of life at least the same something different has to happen.");
		list_start();
			...
			point_detailed_start('no',8,8,8,"Government have tried but can't seem to spend us out of it on an ongoing basis.");point_end_only();		
		list_end();
