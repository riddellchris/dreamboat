...
echo "
<style name='/slideshows/components/'>
...
if($_GET['tertiary_folder'] == 'four'){  $breakpoint = '1730';}
if($_GET['tertiary_folder'] == 'five'){  $breakpoint = '1730';}
if($_GET['tertiary_folder'] == 'six'){   $breakpoint = '1730';}
if($_GET['tertiary_folder'] == 'seven'){ $breakpoint = '1730';}
if($_GET['tertiary_folder'] == 'eight'){ $breakpoint = '1730';}
if($_GET['tertiary_folder'] == 'nine'){ $breakpoint = '1730';}
if($_GET['tertiary_folder'] == 'ten'){ $breakpoint = '1730';}
...
@media only screen and (min-width: ".$breakpoint."px) {.slideshow_descriptive_text{ position: fixed; 
        ...
        if( $_GET['tertiary_folder'] != 'three' AND
            $_GET['tertiary_folder'] != 'four' AND  
            $_GET['tertiary_folder'] != 'six' AND  
            $_GET['tertiary_folder'] != 'seven' AND 
            $_GET['tertiary_folder'] != 'eight'AND  
            $_GET['tertiary_folder'] != 'nine' AND 
