...
copy_big_title('Our model of productivity','our_model_of_productivity');
copy_title('Assumptions','assumptions','open');
	list_start();
...
copy_title('What is productivity','what_is_productivity','open');
	...
	echo "<img src='/legal/prospectus/all_code/our_model_of_productivity/diagrams/productivity_ticks.svg' style='width:100%;'>";
	...
	/*
	copy_title('Collective Productivity','collective_productivity');
...
copy_title('General Factors of Productivity','factors','open');
...
copy_title('Productivity Resistance','productivity_resistance','open');
...
echo "<img src='/legal/prospectus/all_code/our_model_of_productivity/diagrams/individual_productivity_resistance.svg' style='width:100%;'>";	
	...
	list_end();
	echo "<img src='/legal/prospectus/all_code/our_model_of_productivity/diagrams/higher_resistance.svg' style='width:100%;'>";	
	echo "<img src='/legal/prospectus/all_code/our_model_of_productivity/diagrams/lower_resistance.svg' style='width:100%;'>";
...
copy_title('Measurement & Observation','observation','open');
