...
bigger_gap();
copy_big_title('Current Product Disclosure','current_product_disclosure');

copy_title('Introduction','current_product_disclosure_introduction','open');
...
*/	
	...
	echo "<img src='/legal/prospectus/all_code/current_product_disclosure/diagrams/user_types.svg' style='width:100%;'>";	
...
copy_title('Process','process','open');
...
copy_title('Technology','technology','open');
...
copy_title('Services','services','open');
...
copy_title('Pricing','pricing','open');
echo "
	<style>
...
copy_title('Suggested investments', 'suggested_investments','open');
...
copy_title('Expected Benefits', 'expected_benefits','open');
...
copy_title('Initial engagement periods','initial_engagement_periods','open');
...
copy_title('Reporting','reporting','open');
...
copy_title('Payments','payments','open');
echo "
...
copy_title('Refunds & Exit Clauses','refunds_and_exit_clauses','open');
echo "
