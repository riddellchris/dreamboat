...
copy_title('The Economic Problem','the_economic_problem','open');
	...
	paragraph_detailed('no',8,10,10,"With interst rates 0.25% and Phillip Lowe saying negative rates are highly unlikely, this economic lever is no longer available to us.");
	require $_SERVER['DOCUMENT_ROOT']."/legal/pds/all_code/problem_and_solution/economic_background/interest_rate_chart/div.php";
	...
	require $_SERVER['DOCUMENT_ROOT']."/legal/pds/all_code/problem_and_solution/economic_background/household_debt_to_gdp/div.php";	
	...
	//require $_SERVER['DOCUMENT_ROOT']."/legal/pds/all_code/problem_and_solution/economic_background/gdp/div.php";
	...
	require $_SERVER['DOCUMENT_ROOT']."/legal/pds/all_code/problem_and_solution/economic_background/gdp_percentage_change/div.php";
	
	paragraph_detailed('no',10,10,9,"Further to that productivity improvement has all but stalled since 2016.");
	require $_SERVER['DOCUMENT_ROOT']."/legal/pds/all_code/problem_and_solution/economic_background/productivity/div.php";
	
	paragraph_detailed('no',10,9,9,"Wages have stalled and in real terms are on the verge of going backwards.");
	require $_SERVER['DOCUMENT_ROOT']."/legal/pds/all_code/problem_and_solution/economic_background/wages/div.php";	
