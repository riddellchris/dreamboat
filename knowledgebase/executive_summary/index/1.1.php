...
echo "<BR><BR>";
echo "<BR><BR>";
paragraph_detailed('no',9,10,10,"Sadly, worse still, is the per capita GDP improvement trends as they are much closer approximations of the standard of living across the country.");
