...
paragraph_detailed('no',9,10,10,"This trend has fallen from around <span class='blink_me'>2.54%</span> around 1988 to only <span class='blink_me'>0.712%</span> around 2021 and is well on the way to heading backwards.<br> Current estimates put this growth rate reaching 0 in only 12 years in 2033.");

paragraph_detailed('no',7,6,5,"Prior to COVID this the data at the time showed a trend from <span class='blink_me'>2.454%</span> to <span class='blink_me'>0.833%</span> in 2020.");
