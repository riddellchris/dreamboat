...
<div class='hero-image'>
	<div class='hero-text hero_text_no_mobile' id='main_text' style='text-align: center;padding-left:0px;width:100%;'>
	<style>
		...
		<p class='center-text' style='margin:0px;width:100%;'>
			<span style='color:yellow;'>
				<span style='font-size:larger;text-transform:none;'>
					The weekly sales meeting that works.
...
<?php
require $_SERVER['DOCUMENT_ROOT']."/content/services/phone/line_decorations.php";
echo $full_array_of_lines;
?>
