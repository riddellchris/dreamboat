...
copy_big_title_open('Current Product Disclosure','current_product_disclosure');

	copy_title_open('Introduction','current_product_disclosure_introduction','not_open');
		...
		*/	
			...
			echo "<img src='/knowledgebase/all/current_product_disclosure/diagrams/user_types.svg' style='width:100%;'>";	
	...
	copy_title_open('Process','process','not_open');
	...
	copy_title_open('Pilots','pilots','not_open');
	...
	copy_title_open('Technology','technology','not_open');
		...
		paragraph("This platform can be accessed at <a href='/'>www.dreamboat.com.au</a> - depending on each user’s access level.");
	...
	copy_title_open('Services','services','not_open');
	...
	copy_title_open('Pricing','pricing','not_open');
	echo "
		<style>
	...
	copy_title_open('Suggested investments', 'suggested_investments','not_open');
	...
	copy_title_open('Expected Benefits', 'expected_benefits','not_open');
	...
	copy_title_open('Initial engagement periods','initial_engagement_periods','not_open');
	...
	copy_title_open('Risks','risks','not_open');
	...
	copy_title_open('Reporting','reporting','not_open');
	...
	copy_title_open('Payments','payments','not_open');
	echo "
	...
	copy_title_open('Refunds & Exit Clauses','refunds_and_exit_clauses','not_open');
	echo "
