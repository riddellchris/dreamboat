...
copy_big_title_open('Future Product Intentions','future_product_intentions');
	//build the facebook of productivity improvement NOT productivity management and provide sufficient services to enable and 
	
	paragraph("According to our long term objective of ensuring productivity improvement in Australia at above 2.5% p.a. our mission is to help every user of our service improve their productivity in the range of between 5 and 10% per annum, therefore driving the countries collecting productivity as appropriate.");
	paragraph("In order to acheive this our focus is always on building and expanding our technology foundations that facilitate everything we do as the diagram below shows.");
	
	
	echo "<img src='/knowledgebase/all/future_product_intentions/diagrams/technology_foundations.svg' style='width: 80%; margin-left: 10%;'>";
	echo "<br><br><br><br>";
	
	$copy = "Imagine the impact on the world if Facebook was built to actually improve productivity";
	require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/thought_experiment.php";
	echo "<br><br>";
	$copy = "This is our intention with every dollar spend on technology development";
	require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/shameless_self_promotion.php";
	
	echo "<br><br><br><br>";
	paragraph("In more specific details that means ensuring the following occur:");
