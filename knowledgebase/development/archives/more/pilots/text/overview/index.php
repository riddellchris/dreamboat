		...
		<p class='center-text' style='margin:0px;width:100%;'>
			<span style='color:yellow;'>
				<span style='font-size:larger;text-transform:none;'>
					Keep your selling improving,<br> live through our CRM.	
				</span>
			</span>
		</p>
	  </div>	  
</div>
<div class='top-right' style='width:120%;overflow-x:hidden;margin-left:-10%;'>
	<?php 
		
	require $_SERVER['DOCUMENT_ROOT']."/text/arrows.php";
	echo $full_fish ?>
</div> 
...
<div class='hero-image second_hero_image' style='height:45vh;padding-bottom:14vh;padding-top:14vh;'>
...
@media screen and (max-width: 600px){.hero-text{font-size:25px;}.hero-subtext{font-size:24px;}}
		...
		<p class='center-text' style='margin:4%;width:75%;text-align: left;'>
	
				<span style='font-size:larger;text-transform:none;'>
				Connect with our consultants, get advice, encouragment and direction
				24/7
				</span>
		</p>						
	  </div>	  
...
<div style='width:100%;text-align:center;display: inline-block;margin-top:15vh;'>
	<div style=' display: inline-block;width:75%;' class='fa_for_content'>
		<div class='icon-divs'>
			...
			<span class='prompt-font'>perform<br>better</span>
		</div>
		<div class='icon-divs'>
			<i style='font-size: 4em;display:inline-block;'  class="fa fa-road"></i><br>
			<span class='prompt-font'>stay on <br>track</span>
		</div>
...
<div style='width:100%;text-align:center;display: inline-block;margin-top:45vh;'>
	<div style=' display: inline-block;width:75%;' class='fa_for_content'>
		...
		<div class='icon-divs'>
			...
			<span class='prompt-font'>perfor<br>less</span>
		</div>
...
@media screen and (max-width: 600px){.hero-text{font-size:25px;}.hero-subtext{font-size:24px;}}
		...
		<p class='center-text' style='margin:0px;width:100%;text-align:center;'>
				...
				<span style='font-size:larger;text-transform:none;'>
					...
					Get unlimited text-based assistance for $50+GST per month<!--<br> ...after two weeks free.-->
