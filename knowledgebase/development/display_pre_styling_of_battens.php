...
@media screen  and (min-width: 1300px){	
				#prospectus_body_div{	margin-left:30vmin;	margin-right:30vmin;	}
			//	.collapsible{			  width: 64vmin;	}

				
				}
@media screen  and (max-width: 1300px)  and (min-width: 600px){		#prospectus_body_div{	margin-left:8vmin;	margin-right:8vmin;	}}
@media screen  and (max-width: 600px){					#prospectus_body_div{	margin-left:2vmin;	margin-right:2vmin;	}}
";
...
if(	check_tertiary_folder_not('flyer') AND
	...
	require_file("/knowledgebase/all/welcome/display.php");
	require_file("/knowledgebase/all/instructions/display.php");
}

	//currently displayed for all but needs some work
	require_file("/knowledgebase/all/problem_and_solution/display.php");
	require_file("/knowledgebase/all/our_model_of_productivity/display.php");
	require_file("/knowledgebase/all/causes_of_productivity_imperfections/display.php");
	require_file("/knowledgebase/all/our_model_of_productivity_improvement/display.php");
	require_file("/knowledgebase/all/current_product_disclosure/display.php");
	require_file("/knowledgebase/all/future_product_intentions/display.php");
	require_file("/knowledgebase/all/your_options/display.php");
	require_file("/knowledgebase/all/contact_us/display.php");
...
require_file("/components/functions/javascript/open_close_content_div_adding_removing_new_hidden_class.php");
