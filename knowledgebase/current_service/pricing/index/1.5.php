...
paragraph_detailed('no', 8,8,8,"As per the input points and the feedback access points we charge the following*:");
	...
	list_start();
		...
		point_detailed_start('yes',8,8,8,"&nbsp;&nbsp;From $50 per user per month for insights and optimisations based on your business data.");
            list_start();
		...
		point_detailed_start('no',8,8,8,"&nbsp;&nbsp;From $50 per user per month for optimisations via APIs to your applications.");
            list_start();
 		        point_detailed_start('no',8,8,4,"Requires <a href='/knowledgebase/current_service/phases_of_engagement/'>Secondary API data implementations</a> to be underway prior to access.");           
            list_end();
		point_detailed_start('no',8,8,8,"&nbsp;&nbsp;From $50 per user per month for access to our platform.");
            list_start();
            ...
            list_end();
		point_detailed_start('no',8,8,8,"&nbsp;&nbsp;From $75 per user per month for ongoing digital pilot communication.");
//additional consulting - hourly.
            list_start();
 		        point_detailed_start('no',8,8,4,"Typically not enabled until <a href='/knowledgebase/current_service/phases_of_engagement/'>connected mapping</a> underway.");           
            list_end();
		point_detailed_start('no',8,8,8,"From $70 per user per month + GST for monthly 30 minute phone consultations**.");	
		
		
		//this is the first thing to add from a perspective of consulting
		point_detailed_start('no',8,8,8,"From $130 per user per month + GST for fortnightly 30 minute phone consultations**.");	point_end_only();	
		    list_start();
 		        point_detailed_start('no',8,8,4,"Most common starting point for all users.");           
            list_end();
		point_detailed_start('no',8,8,8,"From $250 per user per month + GST for weekly 30 minute phone consultations**.");	point_end_only();	
			list_start();
 		        point_detailed_start('no',8,8,4,"Very common frequency for managers and owners.");           
            list_end();
		point_detailed_start('no',8,8,8,"From $450 per user per month  + GST for weekly hour long phone consultations**.");	point_end_only();	
			list_start();
...
paragraph_detailed('no',8,8,8,"**All time is tracked and billed accordingly.");	
