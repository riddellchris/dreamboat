...
paragraph_detailed('no', 8,8,8,"As per the input points and the feedback access points we charge the following:");
	...
	list_start();
		point_detailed_start('yes',8,8,8,"Nothing to contribute your SaaS application data via APIs.");
...
//additional consulting - hourly.
		...
		point_detailed_start('yes',8,8,8,"$130 per user per month + GST for fortnightly 30 minute phone consultations.");		
		point_detailed_start('no',8,8,8,"$250 per user per month + GST for weekly 30 minute phone consultations.");	
		point_detailed_start('no',8,8,8,"$450 per user per month  + GST for weekly hour long phone consultations.");			
	list_end();
