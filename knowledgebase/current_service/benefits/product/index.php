...
require $_SERVER['DOCUMENT_ROOT']."/knowledgebase/components/layout/pre_content.php";
	...
	echo "<br>";
		...
		list_start();
			...
			point_detailed_start('no',8,8,8,"Steady consistent progess towards better productivity across the entire company.");point_end_only();
	...
	echo "<br>";		
		...
		list_start();
			point_detailed_start('no',8,8,8,"Sustained wage growth somewhat proportional to productivity improvements.");point_end_only();		
			...
			point_detailed_start('no',8,8,8,"A new direction and national identity of being market leaders across numerous industries thanks to innovations found on the search for more productivity.");point_end_only();									
