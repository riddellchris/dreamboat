...
echo "<table>";
    ...
    //Steve Rouget client ids
    if( $_SESSION['viewing_client_id'] == '4402' OR
        $_SESSION['viewing_client_id'] == '4400' OR
        $_SESSION['viewing_client_id'] == '4401' OR
        $_SESSION['viewing_client_id'] == '4399' 
        ){
        $default_setup = 'no';
        ...
        $_SESSION['reporting']['6_chart_A4']['chart_position'][6] = 'financials_expenses_wages_as_percentage_of_revenue_1_div';
