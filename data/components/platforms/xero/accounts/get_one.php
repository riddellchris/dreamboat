...
require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/accounts/api_request.php";

//now for all accounts we want to see if they are already stored or not and then store.
...
for($i = 0; $i < $number_of_accounts; $i ++){
    ...
    require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/accounts/sql/check_if_matching_entry_exists.php";
    if($number_of_results === 0){
        require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/accounts/sql/insert_new_entry.php";
    }
}