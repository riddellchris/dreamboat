...
require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/budgets/api_request.php";

//now for all budgets we want to see if they are already stored or not and then store.
...
//for all budgets 
for($i = 0; $i < $number_of_budgets; $i ++){
    require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/budgets/sql/check_if_matching_entry_exists.php";

    //echo "<br>";  
    if($number_of_results === 0){
        require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/budgets/sql/insert_new_entry.php";
