...
$connected_successfully['xero'] = 'no';
...
//    exit();
    ...
    //IF THIS DOESN'T COME BACK AS AN ERROR
        //THEN PRINT IT OUT AND BOOM WE ARE DONE ON THE XERO STORAGE FRONT

            $connected_successfully['xero']  = 'yes';
