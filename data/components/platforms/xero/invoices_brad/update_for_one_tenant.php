...
unset($sql_for_insert_of_12_month_data);
        ...
        //echo "hi";
            ...
            $url_for_api_request =   "https://api.xero.com/api.xro/2.0/Invoices";
            ...
            require $_SERVER['DOCUMENT_ROOT']."/data/components/platforms/xero/invoices_brad/json_breakdown_and_storage.php";
