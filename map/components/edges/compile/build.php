...
if($counter != 0){
	...
	$result = mysqli_query($conn, $sql);
		...
		if($_SESSION['map_edge_colour'] 	== 'users_time'	){$color_key 		= 'time';			$hits_the_issue = 'yes';}
		if($_SESSION['map_edge_colour'] 	== 'financial'	){$color_key 		= 'financial_flow';	$hits_the_issue = 'yes';}	
		if($hits_the_issue == 'no'){	$color_key  = $_SESSION['map_edge_colour'];}	else{	$hits_the_issue = 'no';}
...
if(isset($edges_to_finally_display['item_a_database'])){
	for($i = 0; $i < count($edges_to_finally_display['item_a_database']); $i ++){
		...
		while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
			...
			if($_SESSION['map_edge_colour'] 	== 'users_time'	){$color_column 		= 'time';			$hits_the_issue = 'yes';}
			if($_SESSION['map_edge_colour'] 	== 'financial'	){$color_column 		= 'financial_flow';	$hits_the_issue = 'yes';}
			if($hits_the_issue == 'no'){	$color_column  = $_SESSION['map_edge_colour'];}	else{	$hits_the_issue = 'no';}
		...
		//if either of them is nondescript then we just leave at the default color (grey) & default thickness
			...
			//so first let's do opacity
				...
				//set a range of colours or even just opacities to apply for a given RBG (this is the way to go to start with)
		...
		if($_SESSION['map_edge_colour'] == 'non_descript'){							$edge_color = "rgba(206,206,206,$opacity_of_this_edge)";	$hover_color = "rgba(166,166,166,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'financial'){							$edge_color = "rgba(77,77,77,$opacity_of_this_edge)";		$hover_color = "rgba(26,26,26,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'users_time'){							$edge_color = "rgba(255,192,203,$opacity_of_this_edge)";	$hover_color = "rgba(227,136,151,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'productivity'){							$edge_color = "rgba(115,102,255,$opacity_of_this_edge)";	$hover_color = "rgba(59,47,194,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'productivity_improvement_potential'){	$edge_color = "rgba(115,102,255,$opacity_of_this_edge)";	$hover_color = "rgba(59,47,194,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'communication'){						$edge_color = "rgba(206,206,206,$opacity_of_this_edge)";	$hover_color = "rgba(166,166,166,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'trust'){								$edge_color = "rgba(206,206,206,$opacity_of_this_edge)";	$hover_color = "rgba(166,166,166,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'quality'){								$edge_color = "rgba(206,206,206,$opacity_of_this_edge)";	$hover_color = "rgba(166,166,166,$opacity_of_this_edge)";	}		
		if($_SESSION['map_edge_colour'] == 'kpi_1'){								$edge_color = "rgba(255,0,0,$opacity_of_this_edge)";		$hover_color = "rgba(173,0,0,$opacity_of_this_edge)";		}
		if($_SESSION['map_edge_colour'] == 'kpi_2'){								$edge_color = "rgba(0,0,255,$opacity_of_this_edge)";		$hover_color = "rgba(0,9,179,$opacity_of_this_edge)";		}
		if($_SESSION['map_edge_colour'] == 'kpi_3'){								$edge_color = "rgba(255,165,0,$opacity_of_this_edge)";	$hover_color = "rgba(222,144,0,$opacity_of_this_edge)";	}
		if($_SESSION['map_edge_colour'] == 'kpi_4'){								$edge_color = "rgba(0,255,0,$opacity_of_this_edge)";		$hover_color = "rgba(0,194,0,$opacity_of_this_edge)";		}


		/* JUST FOR REVERENCE OF THE ORIGINAL HEX CODES
		if($_SESSION['map_edge_colour'] == 'non_descript'){							$edge_color = "#cecece";	$hover_color = "#a6a6a6";}
		if($_SESSION['map_edge_colour'] == 'financial'){							$edge_color = "#4d4d4d";	$hover_color = "#1a1a1a";}
		if($_SESSION['map_edge_colour'] == 'users_time'){							$edge_color = "#ffc0cb";	$hover_color = "#e38897";}
		if($_SESSION['map_edge_colour'] == 'productivity'){							$edge_color = "#7366ff";	$hover_color = "#3b2fc2";}
		if($_SESSION['map_edge_colour'] == 'productivity_improvement_potential'){	$edge_color = "#7366ff";	$hover_color = "#3b2fc2";}
		if($_SESSION['map_edge_colour'] == 'communication'){						$edge_color = "#cecece";	$hover_color = "#a6a6a6";}
		if($_SESSION['map_edge_colour'] == 'trust'){								$edge_color = "#cecece";	$hover_color = "#a6a6a6";}
		if($_SESSION['map_edge_colour'] == 'kpi_1'){								$edge_color = "red";		$hover_color = "#ad0000";}
		if($_SESSION['map_edge_colour'] == 'kpi_2'){								$edge_color = "blue";		$hover_color = "#0009b3";}
		if($_SESSION['map_edge_colour'] == 'kpi_3'){								$edge_color = "orange";		$hover_color = "#de9000";}
		if($_SESSION['map_edge_colour'] == 'kpi_4'){								$edge_color = "green";		$hover_color = "#00c200";}
		*/
