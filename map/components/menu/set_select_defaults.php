...
if(!isset($_SESSION['map_edge_colour'])){		    	$_SESSION['map_edge_colour']   			= 'non_descript';} //this should probably ultimately be adjusted depening on the phase the user is up to 
