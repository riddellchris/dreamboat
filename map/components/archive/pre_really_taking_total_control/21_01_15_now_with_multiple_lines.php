...
?>        
          ...
          ['x', 	'Nodes', 	'link_1',	{'type': 'string', 'role': 'style'},    			{type:'string', role:'tooltip','p': {'html': true}}],
          [0,  		165, 		null, 		'point { size: 18;shape-type: star;fill-color: #cecece;}',	'html name for this tooltip'],          
          [1,  		165, 		null, 		'point { size: 18;shape-type: star;}',		'html name for this tooltip'],

//N.B.
//drawing lines can only be done between two points right next to each other
          [2,  		135, 		135, 		'point { size: 18;}','html name for this tooltip - 2,135'],
          [250,  	250, 		250, 		'point { size: 18; shape-type: star; fill-color: #a52714;}','html name for this tooltip'],
          [3,  		139, 		null, 		'point { size: 18;}','html name for this tooltip'],
          [4,  		136, 		null, 		'point { size: 18;}','html name for this tooltip'],
          
          [250,  	250,		250, 		'point { size: 18;shape-type: circle;fill-color: #cecece;}','html name for this tooltip']   ,           
          [300,  	300,		300, 		'point { size: 18;shape-type: circle;fill-color: #cecece;}','html name for this tooltip']          
        ]);
