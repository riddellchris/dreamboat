...
if(mysqli_num_rows($result) == 0){
	...
	echo "<form style='display: inline-block; width:100%; text-align:center;' method='post' action='/components/map_engine/edges/change_edges.php'  >";
...
$sql = "";
	...
	if($relationship_exits == 'yes'){	
		if($_GET['secondary_folder'] == 'edges'){require $_SERVER['DOCUMENT_ROOT']."/components/map_engine/edges/input_display.php";}
			require $_SERVER['DOCUMENT_ROOT']."/components/discussion/display.php";
	}
	else{
		//under these two selects
		//would you like to add a relationship between these two points?
	}
