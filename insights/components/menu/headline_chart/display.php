...
//echo $_SESSION['insights_menu'];
//exit();

if(!isset($_SESSION['insights_menu'])){$_SESSION['insights_menu'] = 'time_per_activity';}

//then display and allow these people to make new views
echo "<form method='post' action='/insights/components/menu/headline_chart/change.php' style='display:inline-block;'>";
    echo "<select name='headline_chart'  onchange='this.form.submit()'>";
        ...
        if($_SESSION['viewing_client_id'] == 4231 OR $_SESSION['viewing_client_id'] == 1){
            echo "<optgroup label = 'Time Charts'>";
                ...
                if($_SESSION['insights_menu'] == $name){echo " selected ";}
